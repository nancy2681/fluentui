...
import { ClassnamesMappingForSlot } from './makeStyles';
...
export function mergeClasses(): string {
  ...
  const sequenceMappings: ClassnamesMappingForSlot[] = [];
  ...
  const resultDefinitions = Object.assign.apply<Object, ClassnamesMappingForSlot[], ClassnamesMappingForSlot>(
    Object,
  ...
  for (const property in resultDefinitions) {
    const resultDefinition: string | string[] = resultDefinitions[property];
    const hasRTLClassName = typeof resultDefinition === 'object';
